...
// clang-format off
enum class DataIOFunction {
    READAREA, WRITEAREA, READMULTI, WRITEMULTI, PLCSTATUS, GETPROTECTION, CLEARSESSIONPW,
    SETSESSIONPW, PLCSTOP, PLCCOLDSTART, PLCHOTSTART, GETCPINFO, GETCPUINFO, GETORDERCODE,
    SETPLCSYSTEMDATETIME, GETPLCDATETIME, COMPRESS, COPYRAMTOROM, SETPLCDATETIME, DBFILL, DBGET,
    DELETEBLOCK, DOWNLOAD, FULLUPLOAD, UPLOAD, LISTBLOCKSOFTYPE, GETAGBLOCKINFO, LISTBLOCKS,
    CONNECT, CONNECTTO, READSZLLIST, READSZL
};
// clang-format on
...
class S7Client : public Napi::ObjectWrap<S7Client> {
  public:
    ...
    Napi::Array S7DataItemToArray(PS7DataItem Items, int len, bool readMulti);
    ...
    Napi::Array S7BlocksOfTypeToArray(PS7BlocksOfType BlocksList, int count);
...
class IOWorkerClient : public Napi::AsyncWorker {
  public:
    ...
    IOWorkerClient(const Napi::Env& env, S7Client* s7client, DataIOFunction caller)
        : Napi::AsyncWorker(env, "IOWorkerClient"), m_deferred(env), s7client(s7client),
          caller(caller) {}
    // 1 args
    IOWorkerClient(const Napi::Env& env, S7Client* s7client, DataIOFunction caller, void* arg1)
        : Napi::AsyncWorker(env, "IOWorkerClient"), m_deferred(env), s7client(s7client),
          caller(caller), pData(arg1) {}
    IOWorkerClient(const Napi::Env& env, S7Client* s7client, DataIOFunction caller, int arg1)
        : Napi::AsyncWorker(env, "IOWorkerClient"), m_deferred(env), s7client(s7client),
          caller(caller), int1(arg1) {}
    // 2 args
    IOWorkerClient(
        const Napi::Env& env, S7Client* s7client, DataIOFunction caller, void* arg1, int arg2)
        : Napi::AsyncWorker(env, "IOWorkerClient"), m_deferred(env), s7client(s7client),
          caller(caller), pData(arg1), int1(arg2) {}
    IOWorkerClient(
        const Napi::Env& env, S7Client* s7client, DataIOFunction caller, int arg1, int arg2)
        : Napi::AsyncWorker(env, "IOWorkerClient"), m_deferred(env), s7client(s7client),
          caller(caller), int1(arg1), int2(arg2) {}
    // 3 args
    IOWorkerClient(const Napi::Env& env,
                   S7Client* s7client,
                   ...
                   int arg3)
        : Napi::AsyncWorker(env, "IOWorkerClient"), m_deferred(env), s7client(s7client),
          caller(caller), pData(arg1), int1(arg2), int2(arg3) {}
    // 4 args
    IOWorkerClient(const Napi::Env& env,
                   S7Client* s7client,
                   DataIOFunction caller,
                   ...
                   int arg4)
        : Napi::AsyncWorker(env, "IOWorkerClient"), m_deferred(env), s7client(s7client),
          caller(caller), pData(arg1), int1(arg2), int2(arg3), int3(arg4) {}
    // 6 args
    IOWorkerClient(const Napi::Env& env,
                   S7Client* s7client,
                   DataIOFunction caller,
                   ...
                   int arg6)
        : Napi::AsyncWorker(env, "IOWorkerClient"), m_deferred(env), s7client(s7client),
          caller(caller), pData(arg1), int1(arg2), int2(arg3), int3(arg4), int4(arg5), int5(arg6) {}
